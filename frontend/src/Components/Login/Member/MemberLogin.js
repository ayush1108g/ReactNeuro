...
const MemberLogin = (props) => {
    ...
    return (
        <React.Fragment>
            ...
            {signInState && <MemberSignIn onLogin={props.onLogin} signInHandler={signInHandler} signUpHandler={signUpHandler} memberSignInFormSubmit={props.memberSignInFormSubmit} />}
