...
const StudentLogin = (props) => {
    ...
    return (
        <React.Fragment>
            ...
            {signInState && <StudentSignIn onLogin={props.onLogin} signUpHandler={signUpHandler} signInHandler={signInHandler} studentSignInFormSubmit={props.studentSignInFormSubmit} />}
        </React.Fragment>
    );
};
